		...
		<Box>
			<Container maxW="2xl" centerContent>
				<Box padding="4" color="black" maxW="md" pb="1rem">
					...
					<Text color="gray">
						4-digirs code has been sent to your email address <span className="defaultColor">(Change)</span>{' '}
					</Text>
				</Box>
				<Box>
				...
				<Box mt="2rem" mb="7rem">
					...
					<Link as={ReactRouterLink} to="/verifynumber" textDecoration="underline">
						Resend code by phone number
					</Link>
				</Box>
			</Container>
